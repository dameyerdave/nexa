...
#   sh scripts/generate-keys.sh --update-env  # Prints keys and writes them to .env
#   sh scripts/generate-keys.sh | tee keys    # Non-interactive: prints keys only
#
# Adapted from the official Supabase self-hosting generate-keys.sh:
